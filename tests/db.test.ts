...
const mockRDSDataClient = RDSDataClient as jest.MockedClass<typeof RDSDataClient>;
...
describe('db', () => {
  ...
  describe('executeQuery', () => {
    it('should execute query and return results', async () => {
      ...
      expect(mockSend).toHaveBeenCalledWith(expect.any(ExecuteStatementCommand));
    });
    ...
    it('should throw error when neither secretArn nor username/password provided', async () => {
      ...
      ).rejects.toThrow('Either secretArn or both username and password must be provided');
    });
  ...
  describe('testConnection', () => {
    ...
    it('should throw error on connection failure', async () => {
      ...
      await expect(testConnection(config)).rejects.toThrow('Connection test failed');
    });
