...
describe('repl', () => {
  ...
  beforeEach(() => {
    ...
    mockReadline.createInterface.mockReturnValue(mockRlInterface as unknown as readline.Interface);
  ...
  describe('ReplSession', () => {
    ...
    it('should handle SIGINT when SQL is accumulated', async () => {
      ...
      if (lineListener && sigintListener) {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Query cancelled'));
